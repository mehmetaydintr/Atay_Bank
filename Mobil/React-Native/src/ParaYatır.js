...
class ParaCekme extends React.Component {
  ...
  ParaYatır() {
    ...
    axios({
      method: 'put',
      url:
        'https://tutunamayanlar.azurewebsites.net/api/tutunamayanlar/account/paraYukle',
      data: {
  ...
  render() {
    ...
    return (
      <>
        <SafeAreaView>
          <Header headerText="Para Yatırma" />
          <View>
            ...
            <View style={buttonStyle}>
              <Button title="Para Yatır" onPress={() => this.ParaYatır()} />
            </View>
            <View style={buttonStyle}>
              <Button
                title="Drawer"
